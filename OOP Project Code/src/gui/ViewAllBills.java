	...
	public void searchTree(Object M, Object Y, String user) { // Method to search and filter tree data
	    ...
	    for (String y : yearList) {
	        ...
	        for (String m : monthList) {
	            ...
	            mth.add(new DefaultMutableTreeNode(String.format("Month Revenue: $" + "%.2f", monthlyTotal))); // Add monthly total
	            yearTotal += monthlyTotal; // Add monthly total to year total
	        }
